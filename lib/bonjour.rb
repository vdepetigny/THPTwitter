...
followers_array = []
		...
		client.search("#bonjour_monde", result_type: "recent").take(60).each do |tweet|
			followers_array << tweet.user.screen_name
		end
	puts	followers_array.uniq!.size
